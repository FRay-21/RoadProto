...
| 设计软件原型 Agent | `AI_AGENT` | `RD_AI_` | 已实现右侧 WPF Agent 面板、本地 `.NET 8` Agent sidecar、OpenAI-compatible Provider 配置、C++ 白名单工具网关和首个自动化路基模板工具；AutoCAD 图形界面端到端验证待执行 | `docs/modules/agent.md` |
