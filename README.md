...
- 版本：`v0.1.13`
- 构建日期：`20260519`
- 阶段：`RoadModelPickGrip`
- ARX 文件名：`RoadProto_v0.1.13_20260519_RoadModelPickGrip.arx`
...
```text
ARXLOAD artifacts\x64\Release\RoadProto_v0.1.13_20260519_RoadModelPickGrip.arx
