...
- 版本：`v0.1.20`
- 构建日期：`20260522`
- 阶段：`PavementLayerTemplateDisplay`
- ARX 文件名：`RoadProto_v0.1.20_20260522_PavementLayerTemplateDisplay.arx`
...
```text
ARXLOAD artifacts\x64\Release\RoadProto_v0.1.20_20260522_PavementLayerTemplateDisplay.arx
