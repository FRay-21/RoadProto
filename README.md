...
- 版本：`v0.1.26`
- 构建日期：`20260525`
- 阶段：`CrossSectionFrameLabelWhite`
- ARX 文件名：`RoadProto_v0.1.26_20260525_CrossSectionFrameLabelWhite.arx`
...
```text
ARXLOAD artifacts\x64\Release\RoadProto_v0.1.26_20260525_CrossSectionFrameLabelWhite.arx
