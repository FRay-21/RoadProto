...
- 版本：`v0.1.22`
- 构建日期：`20260523`
- 阶段：`PavementLayerTemplateHatchParams`
- ARX 文件名：`RoadProto_v0.1.22_20260523_PavementLayerTemplateHatchParams.arx`
...
- 路面结构层模板命令：命令 `RD_SECTION_PAVEMENT_LAYER_TEMPLATE_CREATE`
  ...
  - 用户点取插入点后生成独立 `DnPavementLayerTemplateEntity`，并打开 WPF 参数窗口编辑模板名称、显示比例、预览宽度、显示方式、结构层列表、每层 RGB 颜色、填充类型、填充角度和填充比例。
...
```text
ARXLOAD artifacts\x64\Release\RoadProto_v0.1.22_20260523_PavementLayerTemplateHatchParams.arx
