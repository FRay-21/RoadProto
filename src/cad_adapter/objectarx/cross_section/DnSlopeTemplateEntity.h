...
class DnSlopeTemplateEntity : public AcDbEntity {
public:
    ACRX_DECLARE_MEMBERS(DnSlopeTemplateEntity);

    DnSlopeTemplateEntity();

    void setTemplateData(const roadproto::domain::cross_section::SlopeTemplateData& data);
    const roadproto::domain::cross_section::SlopeTemplateData& templateData() const;
...
private:
    roadproto::domain::cross_section::SlopeTemplateData templateData_;
